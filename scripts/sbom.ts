 ...
 * 后者 2026-08-30 实测 87 个：83 个带不了或不该带注释头，4 个有意不加
 * （`BASE.md` / `LICENSE.base` / `NOTICE` 与一个 `.gitignore`）。**那 83 个不是
