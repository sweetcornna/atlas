...
| 项 | 内容 |
|---|---|
| 文档版本 | **v2.0**（P0.2 修正复核定稿草案；v1.0 随章程 v2.0 首次产出） |
| 日期 | 2026-08-11 首版 / **2026-08-16 本版** |
| 撰写 | 喻永昌 |
| 状态 | **定稿候审（待全员评审）** —— [§8「修正复核定稿」](#8-修正复核定稿p022026-08-16)已按 P0.2 的 DoD，把 [`selection-m0.md`](./selection-m0.md) §2 的**每一条**修正写成「采纳 / 部分采纳 / 不采纳」的书面结论并附代码依据；§1~§7 原文保留，过时判断**就地加勘误注**指向 §8。**评审通过前本文仍不得当作已定稿件引用**，P0.2 也不因本版落库而自动关闭（关闭条件是全员评审 + 章程 §3 三态逐项确认，见 §8.5）。（v1.0 的「初稿，待 S0 的 P0.2 全员评审后定稿」由本行取代；2026-08-11 按负责人决议更新的 L-5 / 三包处置条目见章程 v2.1 变更记录） |
